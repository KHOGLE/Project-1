...
### Contributors: 
Parker Teske, Carie Bates, Francisco Martinez, Victoria O’Byrne, Katharyn Hogle, Corey Monsma
...
### Data sources: 
Happiness scores are from the World Happiness report 
...
COVID mortality rates are from Johns Hopkins Medical.
Life expectancy data from World Bank.


### Null Hypothesis:
Happiness scores were not impacted by COVID deaths in the years 2020 through 2022.
...
Data is merged for happiness and COVID datasets for 2020, 2021, and 2022, data is merged on 'Country Name'
...
Using a line graph, we could see how the average happiness scores rose seemingly disconnected from the path of the average life expectancy. However, when we broke it down into the years 2018, 2020, and 2022 and compared Life Expectancy with Happiness Scores we were able to see a positive correlation. 2018 r-value: 0.642411, correlation value: 0.8 2020 r-value: 0.611112, correlation value: 0.78 2022 r-value: 0.551364, correlation value: 0.74

### Screenshots of Graphs Created
![Avg_Hap_vs_CD](Images/Avg_Hap_vs_CD.png)
![Happ_CD_USA](Images/Happ_CD_USA.png)
![Avg_Hap_vs_LE](Images/Avg_Hap_vs_LE.png)
![Corr_Life_Hap_2018](Images/Corr_Life_Hap_2018.png)
![Corr_Life_Happ_2020](Images/Corr_Life_Happ_2020.png)
![Corr_Life_Happ_2022](Images/Corr_Life_Happ_2022.png)
